...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <a href="https://instagram.com/delipherartistry" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gold transition-colors">
              ...
              <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gold transition-colors">
      ...
      <section id="gallery" className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <a
              href="https://instagram.com/delipherartistry"
              target="_blank"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://instagram.com/delipherartistry" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold transition-colors">
      ...
      <a
        href="https://wa.me/1234567890?text=Hi! I'd like to book an appointment at DELIPHER ARTISTRY"
        target="_blank"
        rel="noopener noreferrer"
